      ...
      <main>
         ...
         <!-- hero area start -->
         <section class="hero__area hero__height p-relative d-flex align-items-center" data-background="{{ asset('wetland') }}/assets/img/hero/home-1/hero-bg.jpg">
               ...
               <div class="row align-items-center">
                  <div class="col-xxl-7 col-xl-6 col-lg-6">
                     <div class="hero__content pr-80">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".5s">Aplikasi penentuan lokasi kajian islami di Kota Makassar dengan rute terdekat.</p>
                  ...
                  <div class="col-xxl-5 col-xl-6 col-lg-6">
                     <div class="hero__thumb text-end ml-220">
                        <div class="hero__thumb-wrapper p-relative ">
                           <img class="hero-circle" src="{{ asset('wetland') }}/assets/img/hero/home-1/hero-circle.png" alt="">
         ...
         <section class="services__area p-relative pt-150 pb-130">
            <div class="services__shape">
               <img class="services-circle-1" src="{{ asset('wetland') }}/assets/img/icon/services/home-1/circle-1.png" alt="">
               <img class="services-circle-2" src="{{ asset('wetland') }}/assets/img/icon/services/home-1/circle-2.png" alt="">
               <img class="services-dot" src="{{ asset('wetland') }}/assets/img/icon/services/home-1/dot.png" alt="">
               <img class="services-triangle" src="{{ asset('wetland') }}/assets/img/icon/services/home-1/triangle.png" alt="">
            </div>
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xxl-6 offset-xxl-1 col-xl-6 col-lg-6 col-md-10 order-first order-lg-last">
                     <div class="about__thumb-wrapper p-relative ml-40 fix text-end">
                        ...
                        <div class="about__thumb p-absolute">
                           <img class="bounceInUp wow about-big" data-wow-delay=".3s" src="{{ asset('wetland') }}/assets/img/about/home-1/about-1.png" alt="">
                           <img class="about-sm" src="{{ asset('wetland') }}/assets/img/about/home-1/about-1-1.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <section class="about__area pb-160 pt-80 p-relative">
            <div class="about__shape">
               ...
               <img class="about-triangle-2" src="{{ asset('wetland') }}/assets/img/icon/about/home-1/triangle-2.png" alt="">
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__thumb-wrapper p-relative ml--30 fix mr-70">
                        ...
                        <div class="about__thumb about__thumb-2 p-absolute wow fadeInUp" data-wow-delay=".3s">
                           <img class="about-big bounceInUp wow" data-wow-delay=".5s" src="{{ asset('wetland') }}/assets/img/about/home-1/about-2.png" alt="">
                           <img class="about-sm about-sm-2"  src="{{ asset('wetland') }}/assets/img/about/home-1/about-2-1.png" alt="">
                        </div>
                     </div>
                  </div>
         ...
         <section class="testimonial__area pt-150 pb-70 p-relative overflow-y-visible">
            ...
            <div class="testimonial__shape">
               <img class="testimonial-circle-1" src="{{ asset('wetland') }}/assets/img/icon/testimonial/home-1/circle-1.png" alt="">
               <img class="testimonial-circle-2" src="{{ asset('wetland') }}/assets/img/icon/testimonial/home-1/circle-2.png" alt="">
            </div>
            <div class="container">
               <div class="row">
         ...
         <section class="features__area pt-60 pb-155 p-relative overflow-y-visible">
            ...
            <div class="features__shape">
               <img class="features-circle-1" src="{{ asset('wetland') }}/assets/img/icon/features/home-1/circle-1.png" alt="">
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
            ...
            <div class="container">
               <div class="cta__inner p-relative fix z-index-1 wow fadeInUp" data-wow-delay=".5s">
                  <div class="cta__shape">
                     ...
                     <img class="triangle-2" src="{{ asset('wetland') }}/assets/img/cta/home-1/cta-triangle-2.png" alt="">
                  </div>
                  <div class="row">
                     <div class="col-xxl-12">
